...
import { checkNoPath, getOtherEndPoint, getComponentsEdge, getDegree,isDegreeViolated, generateNeighbourhood, getViolated, costFunction} from "./dcmstAlgorithms";
...
export function simulatedAnnealingPenalty(graph, degree) {
  try {    
    ...
    while (K_LEVEL < MAX_TEMP_LEVEL) {
      ...
      else{ //Minimise the degree constraint violation
    ...
    addStates(states, MST, [], [], "Temperature_k = " + TEMP_RANGE + " *= 0.9 = " + TEMP_RANGE*0.9, 13);
    }
