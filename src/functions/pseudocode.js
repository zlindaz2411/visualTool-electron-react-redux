    ...
    switch (name) {
      ...
      case Algorithm.PARALLEL: // Parallel Boruvska
        ...
        case Algorithm.SIMULATED:
          ...
          simulated.push("\xa0 \xa0 \xa0 \xa0\xa0 else if(exp(weight(new T) - weight(T))/Temperature_k > random[0,1])");
          simulated.push("\xa0 \xa0 \xa0 \xa0\xa0  \xa0\xa0 T = new T");
          ...
          case Algorithm.PENALTY:
            ...
            penalty.push("\xa0 \xa0 \xa0 \xa0\xa0 if(penalised weight(new T)  < weight(T) or exp(penalised weight(new T) - weight(T))/Temperature_k > random[0,1]))");
            penalty.push("\xa0 \xa0 \xa0 \xa0\xa0 \xa0\xa0 T = new T");
            penalty.push("\xa0 \xa0 else");
            penalty.push("\xa0 \xa0 \xa0 \xa0\xa0 if(constraint(new T) < constraint(T) or exp(constraint(new T) - constraint(T))/Temperature_k > random[0,1]))");
            penalty.push("\xa0 \xa0 \xa0 \xa0\xa0  \xa0\xa0 T = new T");
