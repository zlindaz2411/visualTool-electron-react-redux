        ...
        <nav>
          <ul>
            <li>
              ...
              >
                <h6>
                  <font color="#84C262"> visual</font>MinSpanningTree
                </h6>
              </NavLink>
            </li>
            <li>
            ...
            <li>
              <div className="algorithms">
                <h5 onClick={() => this.handleDropSubitems(this.MSTRef)}>
                  MST Algorithms &#9662;
                </h5>
              </div>
            </li>
            ...
            <li>
              <div className="algorithms">
                <h5 onClick={() => this.handleDropSubitems(this.DCMSTRef)}>
                  DCMST Algorithms &#9662;
                </h5>
              </div>
            </li>
            ...
            <li>
              <div className="algorithms">
                <h5 onClick={() => this.handleDropSubitems(this.CMSTRef)}>
                  CMST Algorithms &#9662;
                </h5>
              </div>
            </li>
